...
//        EdgeToEdge.enable(this);
        setContentView(R.layout.activity_game_over_tres);
        ...
        if(won){
            ...
            progressManager.unlockGame(4); // Desbloquea el juego 2
        }
        else {
            //rojo
    ...
    public void restartGame(View view) {
        Intent intent = new Intent(this, MiniGameTresActivity.class);
