...
public class BarrasYPuntos extends View {

    int a, b, c;

    private static final String TAG = "Barras";

    public BarrasYPuntos(Context context, int a, int b, int c) {
        super(context);
        this.a = a;
        this.b = b;
        this.c = c;
    ...
    protected void onDraw(@NonNull Canvas canvas) {
        ...
        paint.setColor(Color.CYAN);
        canvas.drawCircle(225, (float) (alto / 2) - a*10, 10, paint);
        ...
        paint.setColor(Color.CYAN);
        canvas.drawCircle(425, (float) (alto / 2) - b*10, 10, paint);
        ...
        paint.setColor(Color.CYAN);
        canvas.drawCircle(625, (float) (alto / 2) - c*10, 10, paint);


        canvas.drawLine(225, (float) (alto/2)-a*10, 425, (float) (alto/2)-b*10, paint);
        canvas.drawLine(425, (float) (alto/2)-b*10, 625, (float) (alto/2)-c*10, paint);
